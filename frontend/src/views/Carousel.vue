    ...
    <div id="myCarousel" class="carousel slide" data-bs-ride="carousel">
      ...
      <div class="carousel-inner">
        <div class="carousel-item active">
          <img class="carousel-image img-fluid" src="@/assets/carousel/1.jpg" />
        ...
        <div class="carousel-item">
          <img class="carousel-image img-fluid" src="@/assets/carousel/2.jpg" />
          <div class="overlay"></div>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="col-lg-4">
          ...
          >
            <img class="img-fluid" src="@/assets/unsplash-photo-1.jpg" />
          </div>
        ...
        <div class="col-lg-4">
          <div
            ...
            style="width: 160px !important; height: 160px !important"
          >
            <img class="img-fluid" src="@/assets/unsplash-photo-2.jpg" />
          </div>
        ...
        <div class="col-lg-4">
          <div
            ...
            style="width: 160px !important; height: 160px !important"
          >
            <img class="img-fluid" src="@/assets/unsplash-photo-3.jpg" />
          </div>
